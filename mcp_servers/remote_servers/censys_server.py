...
async def get_censys_creds(provided_id: Optional[str], provided_secret: Optional[str]) -> tuple:
...
async def censys_search_hosts(query: str, api_id: str = None, api_secret: str = None) -> Dict:
...
@censys_cb
@MCPUtils.cache_result(ttl_seconds=3600)
async def cens_cert_search(fingerprint: str, api_id: str = None, api_secret: str = None) -> Dict:
