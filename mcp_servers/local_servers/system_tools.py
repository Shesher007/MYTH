...
async def analyze_process_tree(pid: Optional[int] = None) -> TitanResponse:
    ...
    try:
        ...
        return TitanResponse(
            success=False, data={}, metadata={"error": f"PID {target_pid} not found"}
        )
    ...
    try:
        ...
        if platform.system() == "Windows":
            ...
            try:
                ...
                system_info["windows_product_name"] = winreg.QueryValueEx(
                    key, "ProductName"
                )[0]
                system_info["windows_build"] = winreg.QueryValueEx(
...
def get_disk_usage() -> Dict:
    ...
    try:
        ...
        return {"partitions": partitions, "total_partitions": len(partitions)}
    except Exception as e:
        return {"error": str(e)}
...
def get_network_info() -> Dict:
    ...
    try:
        ...
        return {"interfaces": interfaces, "total_interfaces": len(interfaces)}
    except Exception as e:
        return {"error": str(e)}
