// MYTH Desktop — AES-256 Encrypted Local Storage (Feature 3)
...
const KDF_SALT: &[u8] = b"MYTH_AES256_v1";
...
fn get_storage_dir() -> Result<PathBuf, String> {
    ...
    let dir = base.join("MYTH").join("encrypted");
...
pub fn save_encrypted_file(filename: String, data: String) -> Result<bool, String> {
    ...
    info!("🔐 [CRYPTO] Saved encrypted file: {}", filename);
    Ok(true)
}
