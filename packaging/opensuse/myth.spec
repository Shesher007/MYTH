...
URL:            {{REPO_URL}}
Source0:        {{REPO_URL}}/releases/download/v%{version}/myth_%{version}_amd64.deb
...
%changelog
* Sat Feb 14 2026 Shesher Hasan <shesher0007@gmail.com> - 1.1.1-1
- Binary-only release 1.1.1
