...
async def applocker_bypass_hunter() -> str:
    ...
    try:
        ...
        targets = [
            ...
            os.path.join(
                os.environ.get("SystemRoot", "C:\\Windows"), "System32\\driverstore"
            ),
            os.path.join(
                os.environ.get("SystemRoot", "C:\\Windows"), "System32\\com\\dmp"
            ),
        ]
        ...
        return format_industrial_result(
            "applocker_bypass_hunter", "Error", error=str(e)
        )
    ...
    try:
        ...
        for api in critical_apis:
            ...
            is_hooked = (
                buffer[0] == 0xE9
                or buffer[0] == 0xC3
                or (buffer[0] == 0x48 and buffer[1] == 0xB8)
            )
