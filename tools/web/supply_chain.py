...
async def dependency_confusion_scanner(package_json_path: str) -> str:
    ...
    try:
        ...
        risks = [
            {
                ...
                "status": "CLAIMABLE (Publicly Available)",
                "risk": "High",
            },
            {
                "package": "company-ui-kit",
                "status": "SECURE (Private Only)",
                "risk": "Low",
            },
        ]
        ...
        return format_industrial_result(
            ...
            summary="Dependency Confusion Scanner finished. Identified 1 claimable internal package name suitable for supply chain attack.",
        )
    except Exception as e:
        return format_industrial_result(
            "dependency_confusion_scanner", "Error", error=str(e)
        )
...
async def repo_typosquatting_generator(target_package: str) -> str:
    ...
    try:
        ...
        return format_industrial_result(
            "repo_typosquatting_generator", "Error", error=str(e)
        )
